...
export const Article: React.FC<Props> = ({ project }) => {
  return (
    <Link tabIndex={0} className="  group/headerZoop rounded-xl focus:block focus:ring-2 focus:ring-[#759dab] " href={`/projects/${encodeURIComponent(project.title)}`}>
      <article tabIndex={-1} className="p-4 md:p-8 focus:ring-2 focus:ring-[#759dab] ">
        ...
        <h2
          ...
          className="z-20 text-xl font-medium duration-1000 lg:text-3xl text-zinc-200 group-hover:text-white font-display"
        >
