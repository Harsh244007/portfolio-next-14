    ...
    tabIndex={1}>
      <div className="my-12 h-max pb-10 md:pt-14 md:pb-46">
        ...
        {/* <div
          ...
          className={` transition-max-height custom-height duration-1000 ease-in ${
        ...
        >
          {" "} */}
            ...
            <p
                    className={`flex flex-col space-y-10 items-stretch justify-center align-top  md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left overflow-hidden text-xl leading-7 mb-4 h-fit ${expandedSection ? "max-h-960" : "max-h-80"}  overflow-hidden transition-max-height`}
                    >
            ...
            <div className="flex flex-wrap flex-row justify-center z-10 md:justify-start">
              {skills.map((item, idx) => {
                return (
                  ...
                  <button onClick={() => setExpandedSection(a=>!a)} className="text-teal-500 hover:underline cursor-pointer">
