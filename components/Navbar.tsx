...
export default function Navbar() {
  ...
  return (
    <header className="w-full mx-auto  px-4 sm:px-20 fixed top-0 z-50 shadow bg-white dark:bg-stone-900 dark:border-b dark:border-stone-600">
      ...
      <div id="progressBarContainer" style={{  height: `${scroll>=0.7?0.7:scroll * 15}px` }}>
        <div id="progressBar" style={{ transform: `scale(${scroll}, 1)`, opacity: `${scroll}`, height: `${scroll>=0.7?0.7:scroll * 15}px` }} />
      </div>
    </header>
  )
}
