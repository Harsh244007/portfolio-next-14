...
export default function Navbar() {
  ...
  return (
    <header className="w-full mx-auto  px-4 sm:px-20 fixed top-0 z-50 shadow  bg-stone-900 border-b border-stone-600">
              ...
              {NAV_ITEMS.map((item, idx) => {
                return (
                  <Link
                    key={idx}
                    to={item.page}
                    className={"block lg:inline-block text-neutral-900  hover:text-neutral-500 text-neutral-100"}
                    // activeClass="active"
                    spy={true}
                    smooth={true}
                    offset={-100}
